...
namespace CodeCallout
{
    ...
    static public class CaptureScreenshot
    {
        ...
        /// </summary>
        public static Bitmap Capture(Rect area)
        {
            ...
            var croppedImage = CropImage(bsource, area);
            return croppedImage;
        }

        private static Bitmap CropImage(BitmapSource src, Rect cropArea)
        {
            var img = GetBitmap(src);
            Bitmap bmpImage = new Bitmap(img);
            return bmpImage.Clone(new Rectangle(0, 0, (int)cropArea.Width, (int)cropArea.Height)
